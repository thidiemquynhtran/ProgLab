...
class Orders(models.Model):
    ...
    customerid = models.ForeignKey(Customers, on_delete=models.SET_NULL, db_column='customerID', blank=True, null=True)  # Field name made lowercase.
    storeid = models.ForeignKey(Stores, on_delete=models.SET_NULL, db_column='storeID', blank=True, null=True)  # Field name made lowercase.
...
class OrderItems(models.Model):
    sku = models.ForeignKey(Products, on_delete=models.SET_NULL, db_column='SKU', blank=True, null=True)  # Field name made lowercase.
    orderid = models.ForeignKey(Orders, on_delete=models.SET_NULL, db_column='orderID', blank=True, null=True)  # Field name made lowercase.
