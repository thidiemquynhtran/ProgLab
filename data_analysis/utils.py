...
def get_revenue_segments(year):
    ...
    if total_customers == 0:
        # No customers found for the given year, return default values
        return {
            'year': year,
            'top_10_revenue': 0,
            'top_11_20_revenue': 0,
    ...
    top_10_cutoff = max(int(total_customers * 0.1), 1)
    top_20_cutoff = max(int(total_customers * 0.2), top_10_cutoff + 1)
